...
class ServerAdmin(admin.ModelAdmin):
    list_display = ['serverid','servername','applicationid','environmenttype','fqdn','ipaddress','domain','isstandaloneserver','issqlclusternode','isagnode','iswsfc','issqlcluster','isag','parentserverid_id','os','spversion','isvm','isphysical','manufacturer','model','ram','cpu','powerplan','osarchitecture','isdecom','decomdate','generaldescription','collectiondate','collectedby','updateddate','updatedby']
